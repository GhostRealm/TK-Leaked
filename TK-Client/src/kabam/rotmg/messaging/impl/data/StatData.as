...
public class StatData
{
   ...
   public static const SMALLSKILL1:int = 89;
   public static const SMALLSKILL2:int = 90;
   public static const SMALLSKILL3:int = 91;
   public static const SMALLSKILL4:int = 92;
   public static const SMALLSKILL5:int = 93;
   public static const SMALLSKILL6:int = 94;
   public static const SMALLSKILL7:int = 95;
   public static const SMALLSKILL8:int = 96;
   public static const SMALLSKILL9:int = 97;
   public static const SMALLSKILL10:int = 98;
   public static const SMALLSKILL11:int = 99;
   public static const SMALLSKILL12:int = 100;
   public static const BIGSKILL1:int = 101;
   public static const BIGSKILL2:int = 102;
   public static const BIGSKILL3:int = 103;
   public static const BIGSKILL4:int = 104;
   public static const BIGSKILL5:int = 105;
   public static const BIGSKILL6:int = 106;
   public static const BIGSKILL7:int = 107;
   public static const BIGSKILL8:int = 108;
   public static const BIGSKILL9:int = 109;
   public static const BIGSKILL10:int = 110;
   public static const BIGSKILL11:int = 111;
   public static const BIGSKILL12:int = 112;

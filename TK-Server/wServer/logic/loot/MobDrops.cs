...
namespace wServer.logic.loot
{
    ...
    public class LootTemplates : MobDrops
    {
        public static MobDrops[] DustLoot()
        {
            return new MobDrops[]
            {
                new ItemLoot("Potion Dust", 0.1),
                new ItemLoot("Potion Dust", 0.01),
                new ItemLoot("Item Dust", 0.01),
                new ItemLoot("Miscellaneous Dust", 0.005),
                new ItemLoot("Special Dust", 0.001)
             };
        }
    }

...
namespace wServer.logic
{
    partial class BehaviorDb
    {
        ...
        .Init("Strange Chest",
            ...
            new Threshold(0.01,
                new ItemLoot("Head of the Calamity", 0.007),
                new ItemLoot("Bloody Robe", 0.015),
                new ItemLoot("Fire Ring", 0.01),
        ...
        .Init("Strange Magician",
            ...
            new Threshold(0.03,
                new ItemLoot("Magicians Hide", 0.0014)
                ),
            new Threshold(0.01,
            ...
            new Threshold(0.001,
                ...
                new ItemLoot("Emerald Staff", 0.01),
                new ItemLoot("Strange Skull", 0.015),
                new ItemLoot("Wrapping Cloak", 0.01),
                new ItemLoot("Corrupted Spell", 0.015),

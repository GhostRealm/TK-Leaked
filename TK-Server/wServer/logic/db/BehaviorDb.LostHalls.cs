...
namespace wServer.logic
{
    partial class BehaviorDb
    {
        ...
        .Init("Marble Colossus",
            ...
            new Threshold(0.002,
                new ItemLoot("Potion of Mana", 1, 0, 0.002),
                new ItemLoot("Potion of Life", 1, 0, 0.002),
                new TierLoot(13, ItemType.Weapon, 0.05, 0, 0.002),
                new TierLoot(13, ItemType.Armor, 0.05, 0, 0.002),
                new TierLoot(6, ItemType.Ability, 0.01, 0, 0.002),
                new TierLoot(6, ItemType.Ring, 0.01, 0, 0.002)
                ),
            new Threshold(0.03,

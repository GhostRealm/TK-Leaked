    ...
    partial class BehaviorDb
    {
        ...
        .Init("Grand Sphinx",
            ...
            new Threshold(0.001,
                ...
                new TierLoot(8, ItemType.Weapon, .22),
                new TierLoot(9, ItemType.Weapon, .17),
                ...
                new TierLoot(8, ItemType.Armor, .22),
                new TierLoot(9, ItemType.Armor, .17),
                new TierLoot(10, ItemType.Armor, .12),
                new TierLoot(11, ItemType.Armor, .09),
                new TierLoot(12, ItemType.Armor, .06),
                new TierLoot(3, ItemType.Ring, .12),
